...
def main(): 
	...
	logging.basicConfig(filename='pbixrefresher.log',filemode='a', format='%(asctime)s - %(levelname)s - %(message)s', level=logging.INFO)
	...
	if args.publish:
		...
		publish_dialog.child_window(title = WORKSPACE, found_index=3)		
